...
export const ptBR: Record<MessageKey, string> = {
  ...
  'csvImport.openTitle': 'Importar itens de uma planilha',
  'csvImport.title': 'Importar itens',
  'csvImport.intoCollection':
    'Cada linha vai para o grupo que a coluna Grupo indicar, e um grupo que ainda não existe é criado.',
  'csvImport.intoGroup':
    'Cada linha vai para {name}. Uma célula Grupo indica um subgrupo dentro dele; deixe vazia para o próprio {name}.',
  'csvImport.format': 'Uma linha por item, colunas separadas por ; — {columns}. Só {name} é obrigatório.',
  ...
  'csvImport.fileChosen': 'Li {name}',
  'csvImport.fileFailed': 'Não deu para ler esse arquivo',
  'csvImport.template': 'Baixar o modelo',
  'csvImport.templateName': 'modelo-importacao-colecionary.csv',
  'csvImport.duplicatesLegend': 'Um item que já está no grupo de destino',
  'csvImport.duplicatesSkip': 'Deixar como está',
  'csvImport.duplicatesUpdate': 'Atualizar com o que veio no arquivo',
  'csvImport.duplicatesHint':
    'Atualizar mexe só nas colunas que o seu arquivo traz. Fotos, notas, valores pagos e campos que ele não cita ficam como estão.',
  'csvImport.summaryHeading': 'O que vai acontecer',
  'csvImport.willCreate.one': '1 item incluído',
  'csvImport.willCreate.other': '{n} itens incluídos',
  'csvImport.willUpdate.one': '1 item atualizado',
  'csvImport.willUpdate.other': '{n} itens atualizados',
  'csvImport.willSkip.one': '1 já está aqui e fica como está',
  'csvImport.willSkip.other': '{n} já estão aqui e ficam como estão',
  'csvImport.newGroups.one': '1 grupo criado',
  'csvImport.newGroups.other': '{n} grupos criados',
  'csvImport.newFields.one': '1 campo novo declarado',
  'csvImport.newFields.other': '{n} campos novos declarados',
  'csvImport.nothingYet': 'Cole suas linhas acima e aqui vai aparecer exatamente o que seria gravado.',
  'csvImport.nothingToWrite': 'Todas as linhas deste arquivo já estão na coleção. Nada seria gravado.',
  'csvImport.previewHeading': 'Linha a linha',
  'csvImport.previewAria': 'O que cada linha vai fazer',
  'csvImport.col.line': 'Linha',
  'csvImport.col.item': 'Item',
  'csvImport.col.group': 'Vai para',
  'csvImport.col.outcome': 'O que acontece',
  'csvImport.outcome.create': 'Incluir',
  'csvImport.outcome.update': 'Atualizar',
  'csvImport.outcome.skip': 'Deixar como está',
  'csvImport.newGroupMark': 'grupo novo',
  'csvImport.moreRows': '…e mais {n} linhas',
  'csvImport.issues.one': '1 linha não pôde ser lida e vai ficar de fora',
  'csvImport.issues.other': '{n} linhas não puderam ser lidas e vão ficar de fora',
  'csvImport.issueLine': 'Linha {line}',
  'csvImport.issueFile': 'Arquivo',
  'csvImport.cancel': 'Cancelar',
  'csvImport.confirm.one': 'Importar 1 item',
  'csvImport.confirm.other': 'Importar {n} itens',
  ...
  'csvImport.error.condition': '“{value}” não é um estado que dê para ler.',
  'csvImport.error.copies': '“{value}” não é um número de exemplares.',
  'csvImport.error.ambiguousGroup':
    'Mais de um grupo se chama “{name}”. Escreva o caminho inteiro, como Bronze / V1.',
