...
export const ptBR: Record<MessageKey, string> = {
  ...
  'collSettings.groups.parentHint': 'O painel abaixo mostra o que muda antes de você confirmar.',
  'collSettings.groups.orderByHint': 'Vale enquanto este grupo está aberto. Subgrupos herdam.',
  'collSettings.groups.targetHint': 'O tamanho do conjunto completo, para medir o progresso pela série. Vazio = não declarada.',
  ...
  'toolbar.searchScoped': 'Buscar nesta coleção…',
  'toolbar.searchAria': 'Buscar nesta coleção',
};
