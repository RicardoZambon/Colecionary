...
export const ptBR: Record<MessageKey, string> = {
  ...
  'collSettings.sharing.accessNote': 'Adicionar alguém aqui registra a pessoa na coleção. Isso por si só não dá acesso: o acesso é decidido para toda a conta em Configurações ▸ Compartilhamento e acesso, e quem não tem conta ainda não consegue entrar.',
