...
export const en = {
  ...
  'collSettings.groups.parentHint': 'The pane below shows what changes before you commit it.',
  'collSettings.groups.orderByHint': 'Applies while this group is open. Sub-groups inherit it.',
  'collSettings.groups.targetHint': 'The complete set’s size, so progress counts against the series. Empty means not declared.',
  ...
  'toolbar.searchScoped': 'Search this collection…',
  'toolbar.searchAria': 'Search this collection',
} as const;
