...
export const en = {
  ...
  // headings and are not repeated here — `csvImport.format` interpolates them.
  'csvImport.open': 'Import',
  'csvImport.openTitle': 'Import items from a spreadsheet',
  'csvImport.title': 'Import items',
  'csvImport.intoCollection':
    'Each row lands in the group its Group column names, and a group that does not exist yet is created.',
  'csvImport.intoGroup':
    'Each row lands in {name}. A Group cell names a sub-group inside it; leave it empty for {name} itself.',
  'csvImport.format': 'One row per item, columns separated by ; — {columns}. Only {name} is required.',
  ...
  'csvImport.fileChosen': 'Read {name}',
  'csvImport.fileFailed': 'That file could not be read',
  'csvImport.template': 'Download the template',
  'csvImport.templateName': 'colecionary-import-template.csv',
  'csvImport.duplicatesLegend': 'An item already in the destination group',
  'csvImport.duplicatesSkip': 'Leave it as it is',
  'csvImport.duplicatesUpdate': 'Update it from the file',
  'csvImport.duplicatesHint':
    'Updating only touches the columns your file carries. Photos, notes, prices paid and fields it does not mention are kept.',
  'csvImport.summaryHeading': 'What this will do',
  'csvImport.willCreate.one': '1 item added',
  'csvImport.willCreate.other': '{n} items added',
  'csvImport.willUpdate.one': '1 item updated',
  'csvImport.willUpdate.other': '{n} items updated',
  'csvImport.willSkip.one': '1 already here, left alone',
  'csvImport.willSkip.other': '{n} already here, left alone',
  'csvImport.newGroups.one': '1 group created',
  'csvImport.newGroups.other': '{n} groups created',
  'csvImport.newFields.one': '1 new field declared',
  'csvImport.newFields.other': '{n} new fields declared',
  'csvImport.nothingYet': 'Paste your rows above and this will say exactly what it would write.',
  'csvImport.nothingToWrite': 'Every row in this file is already in the collection. Nothing would be written.',
  'csvImport.previewHeading': 'Row by row',
  'csvImport.previewAria': 'What each row would do',
  'csvImport.col.line': 'Line',
  'csvImport.col.item': 'Item',
  'csvImport.col.group': 'Lands in',
  'csvImport.col.outcome': 'What happens',
  'csvImport.outcome.create': 'Add',
  'csvImport.outcome.update': 'Update',
  'csvImport.outcome.skip': 'Leave alone',
  'csvImport.newGroupMark': 'new group',
  'csvImport.moreRows': '…and {n} more rows',
  'csvImport.issues.one': '1 line could not be read and will be left out',
  'csvImport.issues.other': '{n} lines could not be read and will be left out',
  'csvImport.issueLine': 'Line {line}',
  'csvImport.issueFile': 'File',
  'csvImport.cancel': 'Cancel',
  'csvImport.confirm.one': 'Import 1 item',
  'csvImport.confirm.other': 'Import {n} items',
  ...
  'csvImport.error.condition': '“{value}” is not a condition this reads.',
  ...
  'itemForm.savingPhotos': 'Waiting for the photos…',
  'itemForm.onlyCopyFields': 'The fields declared here are per copy — edit them on each copy above.',
  'itemForm.copyFieldsHeading': 'This copy',
  'itemForm.declaredFieldsHeading': 'Fields · {name}',
  'itemForm.collectionFieldsName': 'Collection',
  'itemForm.error.nameRequired': 'Give the item a name before saving.',
  'itemForm.addCopyLabel': 'Add copy',
  'itemForm.leave.title': 'Leave without saving?',
  'itemForm.leave.body': 'This item has changes you have not saved. Leaving now discards them.',
  'itemForm.leave.discard': 'Discard the changes',
  'itemForm.leave.keep': 'Keep editing',
  'itemForm.uploadsPending': 'Photos still uploading',
  'confirm.removeCopy.titleAt': 'Remove copy #{n}?',
  'confirm.removeCopy.bodyAt': '{condition}, paid {paid}. What you paid, its condition, when you got it and any notes go with it, and none of that is recorded anywhere else.',
  'confirm.removeCopy.bodyLastAt': '{condition}, paid {paid}. This is the last copy, so the item moves to the wantlist. What you paid, its condition, when you got it and any notes go with it.',
  'toast.item.sectionCleared': 'The section was cleared — this group does not have it',
  'ui.imageSlot.add': 'Add an image',
  'ui.imageSlot.replace': 'Replace the image',
  'item.notFound.body': 'It may have been deleted.',
  'item.backToCollection': 'Back to {name}',
  'item.removePhoto': 'Remove photo',
  'item.browse.noEarlier': 'Nothing earlier',
  'item.browse.noLater': 'Nothing later',
  'item.viewGroup': 'See everything in {name}',
  'item.noPhotoAdd': 'No photo yet — click or drop one here',
  'item.markOwnedPlain': 'I own one — add a copy',
  'browse.showing.one': '{n} of {total} item',
  'browse.showing.other': '{n} of {total} items',
  'browse.summaryAria': 'What the list is showing',
  'browse.filteredBy': 'Filtered by',
  'browse.filter.search': 'Search: {q}',
  'browse.filter.section': 'Section: {name}',
  'browse.filter.condition': 'Condition: {name}',
  'browse.filter.own': 'Status: {name}',
  'browse.filter.tag': 'Tag: #{tag}',
  'browse.filter.remove': 'Remove the filter {label}',
  'browse.moved': '{name} moved to position {position} of {total}',
  'browse.dropHere': 'Drop here',
  'itemList.footHeld.one': '{owned} of {rows} owned · {copies} copy',
  'itemList.footHeld.other': '{owned} of {rows} owned · {copies} copies',
  'bulk.clearSelection': 'Clear selection',
  'collection.notFoundBody': 'The link may be old, or the collection may have been deleted.',
  'filters.conditionOwnedOnly': 'A condition belongs to a copy, and a wantlist entry has none.',
  'breadcrumb.hidePanelLabel': 'Hide the group panel',
  'collection.notFoundTitle': 'Collection not found',
  'login.expired': 'Your session expired — sign in again to pick up where you left off.',
  'login.forgotPassword': 'Forgot your password? There is no reset flow yet — ask the vault’s owner to set a new one for you.',
  'login.heading': 'Sign in to Vault',
  'dashboard.empty.title': 'Your vault is empty',
  'dashboard.empty.body': 'Create a collection to start cataloguing, or pick a ready-made one from the store.',
  'dashboard.empty.store': 'Browse the store',
  'dashboard.empty.readOnly.title': 'Nothing shared with you yet',
  'dashboard.empty.readOnly.body': 'You can read this vault but not change it. Collections will appear here once someone adds them.',
  'dashboard.recent.empty': 'Nothing added yet',
  'dashboard.createCollection': 'New collection',
  'dashboard.appreciationPct': '{pct}% vs purchase',
  'dashboard.appreciationIn': '{pct}% vs purchase, in {currency}',
  'dashboard.appreciationMixed': 'purchases in several currencies',
  'nav.collections.empty': 'No collections yet',
  'nav.appearance': 'Theme and language',
  'common.inUse': 'In use',
  'common.select': 'Select',
  'settings.access.people': 'People with access',
  'settings.access.sub': 'Everyone listed here can sign in to this vault. The role decides what they may change.',
  'store.empty.title': 'The store is empty',
  'store.empty.body': 'There is no ready-made collection to add right now. Create one of your own instead.',
  'shell.notFound.title': 'We couldn’t open that address',
  'shell.notFound.body': 'Nothing in this vault answers to {url}. The link may be mistyped, or what it pointed at may have been deleted.',
  'setup.applying.hint': 'The server is restarting to pick up the new configuration. This takes up to a minute — don’t reload the page.',
  'setup.applying.slow': 'Still waiting — the server is taking longer than usual. Don’t reload.',
  'setup.stepAnnounce': 'Step {n} of {total} — {name}',
  'setup.required': 'Fill this in to continue.',
  'setup.fixFirst': 'Something above still needs filling in.',
  'collSettings.movedOn.title': 'Saved somewhere else while you were editing',
  'collSettings.movedOn.body': 'The version in the vault is no longer the one this page started from, so saving is paused. Take the latest and lose what you typed here, or keep yours and write over what was saved.',
  'collSettings.movedOn.take': 'Take the latest (your edits here are lost)',
  'collSettings.movedOn.keep': 'Keep mine (writes over the other save)',
  'collSettings.saving': 'Saving…',
  'collSettings.saved': 'All changes saved',
  'collSettings.notSaved': 'Not saved — nothing has left this page. Try again in a moment.',
  'collSettings.fields.labelScoped': 'Fields on every item',
  'collSettings.fields.addCollection': '+ Field for the collection',
  'collSettings.groups.fieldsIn': 'Fields on {name}',
  'collSettings.groups.addFieldIn': '+ Field in {name}',
  'collSettings.groups.fieldsHint': 'Fields apply to every item in this group and its sub-groups. The type decides how it sorts; the scope says whether the value belongs to the item or to each copy. Both are set on the field once it exists.',
  'collSettings.groups.intro': 'Pick a group on the left. Everything here applies to it and to its sub-groups.',
  'collSettings.groups.nameHint': 'Renames apply as you type.',
  'collSettings.groups.parentHint': 'Moving a group changes which fields its items show and which order they follow, so the pane below says what will change before you commit it.',
  'collSettings.groups.orderByHint': 'The order the items follow when this group is open. Sub-groups inherit it unless they set their own.',
  'collSettings.groups.targetHint': 'How many items the complete set has, when you know it — a 120-issue run, a 24-card set — so progress is measured against the series instead of against what you have catalogued. Leave it empty for «not declared».',
  'collSettings.groups.targetPlaceholder': 'not declared',
  'collSettings.groups.moveUnapplied': 'Chosen, not moved yet',
  'collSettings.sections.hint': 'A section divides the items of one group without adding a level: it declares no fields and no order of its own, and you arrange the sections by hand — Bronze, Silver, Gold, not alphabetically.',
  'collSettings.sections.migrateHeading': 'Migrating an old tree',
  'collSettings.sharing.emailLabel': 'Email',
  ...
  'confirm.rescopeField.body.other': '{n} items hold a value for «{name}» on the item itself. Nothing is deleted — the values stay where they are and show again if you move the field back — but they stop being displayed anywhere until then.',
  'confirm.rescopeField.confirm': 'Move it to per-copy',
  'confirm.convertSections.title.one': 'Turn 1 sub-group into a section?',
  'confirm.convertSections.title.other': 'Turn {n} sub-groups into sections?',
  'confirm.convertSections.body': '{names} stop being groups. Their items move up into {parent}, each under a section of the same name. This cannot be undone — the vault has no undo. Export the collection first if you want a copy to fall back on.',
  'confirm.convertSections.confirm.one': 'Convert 1 sub-group',
  'confirm.convertSections.confirm.other': 'Convert {n} sub-groups',
  'confirm.pendingMove.title': 'Leave without moving {name}?',
  'confirm.pendingMove.body': 'You chose a new place for it and never confirmed the move, so it is still where it was. Leaving now discards the choice.',
  'confirm.pendingMove.confirm': 'Leave without moving it',
  'toast.field.rescoped': '«{name}» now describes {scope}',
  'toast.field.retyped': '«{name}» is now a {type} field',
  'toast.field.orderCleared': '{groups} were ordered by «{name}», and now follow the default',
  'toast.group.moveDiscarded': 'The move of {name} was never applied',
  'csvImport.newGroupsNamed.one': 'New group: {names}',
  'csvImport.newGroupsNamed.other': '{n} new groups: {names}',
  'csvImport.newFieldsNamed.one': 'New field: {names}',
  'csvImport.newFieldsNamed.other': '{n} new fields: {names}',
  'csvImport.landsIn': 'Where the rows land',
  'csvImport.landsInRows.one': '1 row',
  'csvImport.landsInRows.other': '{n} rows',
  'csvImport.showAllRows': 'Show all {n} rows',
  'csvImport.showFewerRows': 'Show the first rows only',
  'import.confirmOverwrite.one': 'Overwrite 1 collection',
  'import.confirmOverwrite.other': 'Overwrite {n} collections',
  'import.entryLive.one': '1 item in your vault right now',
  'import.entryLive.other': '{n} items in your vault right now',
  'import.entryArchiveUnknown': 'The archive does not say how many it carries.',
  'import.unanswered.one': '1 collection above still needs an answer.',
  'import.unanswered.other': '{n} collections above still need an answer.',
  'import.exportFirst': 'Export the whole vault first',
