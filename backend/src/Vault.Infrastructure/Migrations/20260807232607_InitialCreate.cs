        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    LinkShare = table.Column<bool>(type: "bit", nullable: false),
                    BannerImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IconImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Condition = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    ...
                    Img = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: false),
                    Owned = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    PhotoIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
